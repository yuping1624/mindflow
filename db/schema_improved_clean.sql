-- ============================================================================
-- MindFlow Database Schema - IMPROVED VERSION (Clean for New Projects)
-- Includes all security fixes, performance optimizations, and data integrity
-- Safe for fresh installations - no DROP statements
-- ============================================================================
...
-- Create trigger (only if it doesn't exist - safe for new projects)
DO $$
BEGIN
  IF NOT EXISTS (
